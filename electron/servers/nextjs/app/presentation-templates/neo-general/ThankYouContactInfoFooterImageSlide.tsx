...
export const Schema = z.object({
    ...
    email: z.string().max(30).describe('Email address text').default('SWAGSlides@gmail.com'),
    website: z.string().max(30).describe('Website URL text').default('www.SWAGSlides.com'),
    footerImage: z.object({
        __image_url__: z.string(),
        __image_prompt__: z.string().max(100)
    }).default({
        __image_url__: "https://SWAGSlides-public-assets.s3.ap-southeast-1.amazonaws.com/replaceable_template_image.png",
