...
export const Schema = z.object({
    ...
    timelineItems: z.array(z.object({
        ...
        { icon: { __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'checkmark' }, year: '2021', eventDescription: 'Briefly elaborate on what you want to discuss.' },
        { icon: { __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'checkmark' }, year: '2020', eventDescription: 'Briefly elaborate on what you want to discuss.' },
        { icon: { __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'checkmark' }, year: '2019', eventDescription: 'Briefly elaborate on what you want to discuss.' },
        { icon: { __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'checkmark' }, year: '2018', eventDescription: 'Briefly elaborate on what you want to discuss.' },
        { icon: { __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'checkmark' }, year: '2017', eventDescription: 'Briefly elaborate on what you want to discuss.' },
    ]),
});
