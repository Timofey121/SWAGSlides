...
def get_system_prompt(
    ...
    return f"""
        ...
        - CRITICAL: Generate ALL content ONLY in the language specified in "Output Language". Never use Chinese, Japanese, Arabic, or any other language unless explicitly requested. If Output Language is "Russian" or "English", output must be exclusively in that language.
