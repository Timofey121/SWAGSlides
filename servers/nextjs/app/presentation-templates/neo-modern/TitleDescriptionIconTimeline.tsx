...
export const Schema = z.object({
    ...
    processItems: z.array(z.object({
        ...
        {
            icon: { __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'growth chart' },
            heading: '2021',
            subDescription: 'Briefly elaborate on what you want to discuss.Briefly elaborate on what you want to discuss.'
        },
        {
            icon: { __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'money bag' },
            heading: '2020',
            subDescription: 'Briefly elaborate on what you want to discuss.'
        },
        {
            icon: { __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'global' },
            heading: '2019',
            subDescription: 'Briefly elaborate on what you want to discuss.'
        },
        {
            icon: { __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'handshake' },
            heading: '2018',
            subDescription: 'Briefly elaborate on what you want to discuss.'
        },
        {
            icon: { __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'lightbulb' },
            heading: '2017',
            subDescription: 'Briefly elaborate on what you want to discuss.'
        }
    ])
    ...
    return (
        <>
            <link
                ...
                rel="stylesheet"
            />
            <div className="relative w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-[#FFFFFE] z-20 mx-auto overflow-y-auto flex flex-row items-center justify-between gap-10 px-[115px]"
                ...
                <div className="flex-[0.5] flex flex-col justify-center  gap-[24px]">
                    {processItems?.map((item, index) => (
                        <div key={index} className="flex flex-row items-center gap-[16px]">
                            ...
                            {/* Content Box */}
                            <div className="bg-[#F7F8FF] rounded-[3px] w-full min-h-[92px] flex flex-col justify-center px-[18px]"
                                style={{
