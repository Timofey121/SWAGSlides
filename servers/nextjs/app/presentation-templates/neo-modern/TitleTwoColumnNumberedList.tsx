    ...
    return (
        <>
            <link
                ...
                rel="stylesheet"
            />
            <div className="relative w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-white z-20 mx-auto overflow-y-auto flex items-center px-[85px]"
                style={{
                    ...
                    <div className="flex-1 w-[60%] justify-center ml-[40px]  flex  gap-x-[40px]">
                        ...
                        <div className="flex flex-col ">
                            {firstColumn.map((item, idx) => (
                                <div key={idx} className="flex items-center min-h-[115px] border-b border-[#DCE2FA]"
