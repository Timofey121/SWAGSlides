...
const IconSchema = z.object({
  __icon_url__: z.string().default("https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/fediverse-logo-bold.svg").meta({
...
const Schema = z.object({
  ...
  cards: z.array(z.object({
    ...
    symbolIcon: IconSchema.default({
      __icon_url__: "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/fediverse-logo-bold.png",
    ...
    {
      symbolText: "i",
      symbolIcon: { __icon_url__: "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/fediverse-logo-bold.svg", __icon_query__: "info icon" },
      title: "Visionary Leadership",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor",
    },
    {
      symbolText: "i",
      symbolIcon: { __icon_url__: "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/video-bold.png", __icon_query__: "info icon" },
      title: "Innovation at the Core",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor",
    },
    {
      symbolText: "i",
      symbolIcon: { __icon_url__: "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/receipt-x-bold.png", __icon_query__: "info icon" },
      title: "Customer-Centric Disruption",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor",
    },
    {
      symbolText: "i",
      symbolIcon: { __icon_url__: "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/users-four-bold.png", __icon_query__: "info icon" },
      title: "Customer-Centric Disruption",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor",
    }
  ]).meta({
  ...
  return (
    <>
      <link
        ...
        rel="stylesheet"
      />
      <div className=" w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video relative z-20 mx-auto overflow-y-auto" style={{ fontFamily: "var(--heading-font-family,Playfair Display)", backgroundColor: 'var(--background-color, #FFFFFF)' }}>
