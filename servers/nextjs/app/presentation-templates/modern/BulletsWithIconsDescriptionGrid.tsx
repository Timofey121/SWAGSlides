    ...
    .default([
      {
        ...
        icon: {
          ...
          __icon_url__:
            "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg",
        },
      },
      {
        title: "Industry",
        ...
        icon: {
          ...
          __icon_url__:
            "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/fediverse-logo-bold.svg",
        },
      },
      {
        title: "SEM",
        ...
        icon: {
          ...
          __icon_url__:
            "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/video-bold.svg",
        },
      },
      {
        title: "End User",
        ...
        icon: {
          ...
          __icon_url__:
            "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/users-four-bold.svg",
        },
      },
      {
        title: "Industry",
...
const BulletWithIconsDescriptionGridSlideLayout = ({
  ...
  return (
    <>
      ...
      <div
        className="w-full rounded-sm max-w-[1280px] shadow-lg  aspect-video relative z-20 mx-auto overflow-y-auto border-2 border-gray-800"
        style={{
