...
export const Schema = z.object({
    ...
    listItems: z.array(z.object({
        ...
        {
            icon: { __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'checkmark' },
            heading: '2021',
    ...
    return (
        <>
            <link
                ...
                rel="stylesheet"
            />
            <div className="relative w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-white z-20 mx-auto overflow-y-auto flex items-center justify-between gap-10 px-28 py-20"
