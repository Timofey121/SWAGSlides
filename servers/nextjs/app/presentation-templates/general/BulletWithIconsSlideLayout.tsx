...
const bulletWithIconsSlideSchema = z.object({
    ...
    bulletPoints: z.array(z.object({
    ...
    })).min(1).max(3).default([
        {
            ...
            icon: {
                __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg',
        ...
        },
        {
            ...
            icon: {
                __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/fediverse-logo-bold.svg',
...
const BulletWithIconsSlideLayout: React.FC<BulletWithIconsSlideLayoutProps> = ({ data: slideData }) => {
    ...
    return (
        <>
            ...
            <div
                className="w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-gradient-to-br from-gray-50 to-white relative z-20 mx-auto overflow-y-auto"
                style={{
