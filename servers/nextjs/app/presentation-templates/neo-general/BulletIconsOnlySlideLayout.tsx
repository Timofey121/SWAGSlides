...
const bulletIconsOnlySlideSchema = z.object({
    ...
    bulletPoints: z.array(z.object({
    ...
    })).min(2).max(3).default([
        {
            ...
            icon: {
                __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/code-bold.svg',
        ...
        },
        {
            ...
            icon: {
                __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/users-four-bold.svg',
        ...
        },
        {
            ...
            icon: {
                __icon_url__: 'https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/headphones-bold.svg',
...
const BulletIconsOnlySlideLayout: React.FC<BulletIconsOnlySlideLayoutProps> = ({ data: slideData }) => {
    ...
    return (
        <>
            ...
            <div
                className="w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-white relative z-20 mx-auto overflow-y-auto"
                style={{
