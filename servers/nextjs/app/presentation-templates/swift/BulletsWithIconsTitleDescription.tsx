...
const ItemSchema = z
  ...
  .default({
    icon: {
      __icon_url__:
        "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/graduation-cap-bold.svg",
...
const Schema = z
    ...
    items: z
      ...
      .default([
        ...
        },
        {
          icon: {
            __icon_url__:
              "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/user-bold.svg",
            __icon_query__: "feature icon",
          },
          title: "Lorem ipsum dolor",
          description:
        ...
        },
        {
          icon: {
            __icon_url__:
              "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/calendar-blank-bold.svg",
            __icon_query__: "feature icon",
          },
          title: "Lorem ipsum dolor",
          description:
        ...
        },
        {
          icon: {
            __icon_url__:
              "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/x-bold.svg",
            __icon_query__: "feature icon",
          },
          title: "Lorem ipsum dolor",
          description:
  ...
  .default({
    ...
    items: [
      {
        icon: { __icon_url__: "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/graduation-cap-bold.svg", __icon_query__: "feature icon" },
        title: "Lorem ipsum dolor",
        description:
          "Concise supporting text under the first icon explaining the point.",
      },
      {
        icon: { __icon_url__: "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/user-bold.svg", __icon_query__: "feature icon" },
        title: "Lorem ipsum dolor",
        description:
          "Concise supporting text under the second icon explaining the point.",
      },
      {
        icon: { __icon_url__: "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/calendar-blank-bold.svg", __icon_query__: "feature icon" },
        title: "Lorem ipsum dolor",
        description:
          "Concise supporting text under the third icon explaining the point.",
      },
      {
        icon: { __icon_url__: "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/x-bold.svg", __icon_query__: "feature icon" },
        title: "Lorem ipsum dolor",
        description:
          "Concise supporting text under the fourth icon explaining the point.",
      },
...
const InfographicFourIcons: React.FC<SlideLayoutProps> = ({ data }) => {
  ...
  return (
    <>
      ...
      <div
        className=" w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video relative z-20 mx-auto overflow-y-auto"
        style={{
