...
const IconSchema = z
  .object({
    __icon_url__: z
      .string()
      .default(
        "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/file-text-bold.svg"
      ),
    ...
    features: z
      ...
      .default([
        FeatureSchema.parse({}),
        {
          ...
          icon: IconSchema.parse({
            __icon_url__:
              "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/devices-bold.svg",
          }),
        },
        {
          ...
          icon: IconSchema.parse({
            __icon_url__:
              "https://SWAGSlides-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/chart-line-up-bold.svg",
          }),
        },
        {
