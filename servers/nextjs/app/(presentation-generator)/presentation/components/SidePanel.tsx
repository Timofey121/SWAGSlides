    ...
    <>
      ...
      {!isMobilePanelOpen && (
        <div className="xl:hidden fixed left-4 bottom-4 z-50">
          <ToolTip content={t(language, "showPanel")}>
            <Button
          ...
          >
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center justify-start gap-4">
                <ToolTip content={t(language, "imagePreview")}>
                  <Button
                ...
                <ToolTip content={t(language, "listPreview")}>
                  <Button
                ...
                {isStreaming ? (
                  ...
                  presentationData?.slides.map((slide: any, index: number) => (
                    <div
                      ...
                      className={` cursor-pointer ring-2 p-1  rounded-md transition-all duration-200 ${selectedSlide === index ? ' ring-primary' : 'ring-gray-200'
                        }`}
                    >
