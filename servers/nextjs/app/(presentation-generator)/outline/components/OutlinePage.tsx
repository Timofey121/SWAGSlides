...
import { templates as builtInTemplates } from "../../../presentation-templates";
import { t } from "../../i18n";
        ...
        <div className="flex-grow overflow-y-hidden w-[1200px] mx-auto">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
            <TabsList className="grid w-[50%] mx-auto my-4 grid-cols-2">
              <TabsTrigger value={TABS.OUTLINE}>{t(language, "outlineAndContentTab")}</TabsTrigger>
              <TabsTrigger value={TABS.LAYOUTS}>{t(language, "selectTemplateTab")}</TabsTrigger>
            </TabsList>
