              ...
              <div>
                <ToolTip content="Edit slide with AI">
                  <button
                    ...
                    className={`px-6 py-2 flex gap-2 text-sm items-center group-hover:scale-105 rounded-lg bg-primary hover:bg-primary/90 hover:shadow-md transition-all duration-300 cursor-pointer shadow-md ${
